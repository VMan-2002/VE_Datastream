...
class ControlsSubState extends OptionsSubStateBasic
{
	...
	var keyNameText = new FlxText(0, 0, 800, "Key name").setFormat(Main.codeFontBold, 16, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
