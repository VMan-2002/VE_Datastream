...
class HealthIcon extends SpriteVMan
{
	...
	private final defaultStuff:Map<String, Array<Int>> = [
		...
		'bf-pixel' => [30, 31, 32],
		'demise-pixel' => [4, 4, 5],
		'demise-pixel-old' => [6, 6, 6],
		'monika' => [7, 8, 9],
		'monika-pixel' => [11, 12, 13],
		'monika-pixel-old' => [14, 15, 16],
		'monika-big' => [17, 18, 19],
		'demise-pixel-demake' => [4, 6, 5],
		'monika-pixel-demake' => [11, 15, 13],
		'bf-c' => [21, 22, 23],
		'monika-c' => [24, 25, 26],
		'demise-pixel-c' => [27, 28, 29],
		'bf-pixel-c' => [33, 34, 35],
		'monika-big-c' => [37, 38, 39],
		'bf-b' => [41, 42, 41],
		'monika-b' => [40, 40, 40],
		'bf-s' => [44, 45, 44],
		'monika-s' => [43, 43, 43],
	...
	public function changeCharacter(char:String, isPlayer:Bool = false, ?myMod:String) {
		...
		var isPixel = char.indexOf("-pixel") != -1;
